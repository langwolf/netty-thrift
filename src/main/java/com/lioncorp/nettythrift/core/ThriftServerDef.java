...
import com.lioncorp.nettythrift.processor.DefaultNettyProcessorFactory;
import com.lioncorp.nettythrift.processor.NettyProcessor;
...
public class ThriftServerDef {
	...
	public ThriftServerDef(
			...
			NettyProcessorFactory nettyProcessorFactory, 
			ChannelHandler codecInstaller,
			@SuppressWarnings("rawtypes") TBaseProcessor baseProcessor, 
			ExecutorService executor, 
			long clientIdleTimeout,
			ProtocolFactorySelectorFactory protocolFactorySelectorFactory, 
			HttpResourceHandler httpResourceHandler,
			boolean voidMethodDirectReturn, 
			HttpHandlerFactory httpHandlerFactory, 
			TrafficForecastFactory trafficForecastFac,
		...
		this.processMap = baseProcessor.getProcessMapView();
